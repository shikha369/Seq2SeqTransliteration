  ...
  with variable_scope.variable_scope(
    ...
    def decoder(feed_previous_bool):
      ...
      with variable_scope.variable_scope(
        ...
        outputs, state,x_,y_ = embedding_attention_decoder(
            decoder_inputs,
            encoder_state,
            attention_states,
            cell,dec_cell,attent,beam_search,
  ...
  with variable_scope.variable_scope(
    ...
    if attent == True:   
        if beam_search == True:
            ...
            initial_state_attention=initial_state_attention, beam_size=beam_size)
        else:
    ...
    for i, inp in enumerate(decoder_inputs):
      ...
      if i == 0 and initial_state_attention:
        with variable_scope.variable_scope(
          ...
          attns,att_matrix = attention(state)
      else:
        attns,att_matrix = attention(state)
  ...
  with ops.op_scope(all_inputs, name, "model_with_buckets"):
    for j, bucket in enumerate(buckets):
      with variable_scope.variable_scope(variable_scope.get_variable_scope(),
        ...
        bucket_outputs, _,_,_ = seq2seq(encoder_inputs[:bucket[0]],
